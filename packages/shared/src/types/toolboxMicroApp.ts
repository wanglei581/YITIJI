...
export const BUILTIN_TOOLBOX_MICRO_APPS = [
  ...
  },
  {
    id: 'contract-review',
    title: 'AI签约风险提示',
    shortDescription: '该能力已归入 AI 简历服务的“签约与权益”，不再作为百宝箱微应用发布。',
    category: 'legal',
    priority: 'medium',
    status: 'archived',
    riskLevel: 'restricted',
    permissions: ['file_upload', 'session_only_storage', 'legal_disclaimer'],
    launch: {
      entryType: 'internal_route',
      internalRoute: '/contract-review',
      requiresHostAllowlist: false,
      requiresHumanReview: true,
      productionEnabledByDefault: false,
    },
    ...
    disclaimers: ['仅作条款风险提示，不构成正式法律意见；合同原文不得进入第三方百宝箱应用；该归档记录不得重新发布为百宝箱入口。'],
    commercialValue: '归入 AI 简历服务的签约前个人服务，避免与百宝箱形成重复入口。',
    acceptanceGates: ['仅从 AI 简历服务进入', '禁止百宝箱重复投放', '法务评审', '合同原文短期保留并优先删除', '首方模型通道', '禁止第三方外传', '不在公共屏长期展示合同全文'],
  },
  {
    id: 'exam-paper-print',
    title: '试卷打印',
