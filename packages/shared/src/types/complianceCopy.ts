...
export const COMPLIANCE_FORBIDDEN_TERMS = [
  ...
  '候选人管理',
  '一键报名',
  // 2026-08-09 新增:隐私遮挡的能力天花板(docs/product/pii-redaction-decision-2026-08.md §3.3)。
...
export const COMPLIANCE_FORBIDDEN_TERM_PATTERNS: readonly RegExp[] = [
  ...
  /候选人管理/,
  /一键报名/,
  // 唯一允许的说法是带限定的「已遮挡你确认的 N 处」——它交代了范围(只有你确认的那几处)
  // 且后面必然跟着「请核对预览」。裸的「已遮挡」是无条件承诺,禁止出现,故用否定前瞻。
  /已遮挡(?!你确认的)/,
  /已?无隐私(?:信息|内容)/,
  /隐私已(?:保护|清除|移除)/,
]
