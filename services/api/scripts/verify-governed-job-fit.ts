...
async function main(): Promise<void> {
  ...
  requireAll(aiModule, ['AuthModule', 'FilesModule', 'AsrModule', 'BenefitRedemptionModule', 'MemberPrivacyModule'], 'AiModule 保留 main 的模块依赖（含 Asr/BenefitRedemption/MemberPrivacy）')
