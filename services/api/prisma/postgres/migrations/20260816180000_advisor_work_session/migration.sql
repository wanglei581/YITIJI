...
-- PostgreSQL 侧与 prisma/migrations/20260816180000_advisor_work_session 一一对应。
--
...
CREATE TABLE "AdvisorPin" (
    ...
    CONSTRAINT "AdvisorPin_pkey" PRIMARY KEY ("id")
);
