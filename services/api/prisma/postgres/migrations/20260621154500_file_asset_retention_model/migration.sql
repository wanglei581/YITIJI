...
ALTER TABLE "FileObject" ADD COLUMN "sourceFileId" TEXT;
ALTER TABLE "FileObject" ADD COLUMN "retentionPolicy" TEXT;
ALTER TABLE "FileObject" ADD COLUMN "retentionSetBy" TEXT;
ALTER TABLE "FileObject" ADD COLUMN "retentionConsentAt" TIMESTAMP(3);
...
-- AddForeignKey
ALTER TABLE "FileObject" ADD CONSTRAINT "FileObject_sourceFileId_fkey" FOREIGN KEY ("sourceFileId") REFERENCES "FileObject"("id") ON DELETE SET NULL ON UPDATE CASCADE;
