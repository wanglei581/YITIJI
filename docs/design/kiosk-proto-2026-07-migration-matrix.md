...
| 03 | 03-print-settings.html | 打印参数 | 打印扫描 | `/print/params` →（2026-08-18 起重定向）`/print/preview` | PrintPreviewPage | src/pages/print/PrintPreviewPage.tsx | sessionStorage 流转 | 份数/色彩/双面/缩放/页范围（原型 03 的参数区已由预览页承载） | loading / error(文件不可用) | verify-print-parameter-capability |
