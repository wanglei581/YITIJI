...
flowchart LR
  ...
  app --> resume["/resume<br/>19 页 · 39 端点"]
...
| `/resume/generate/preview` | ResumeGeneratePreviewPage | `apps/kiosk/src/pages/resume/ResumeGeneratePreviewPage.tsx` | 30 | 6 |
...
| `/resume/optimize` | ResumeOptimizePage | `apps/kiosk/src/pages/resume/ResumeOptimizePage.tsx` | 30 | 5 |
