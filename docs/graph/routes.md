...
flowchart LR
  ...
  app --> assistant["/assistant<br/>1 页 · 37 端点"]
  app --> campus["/campus<br/>1 页 · 32 端点"]
  app --> companies["/companies<br/>2 页 · 5 端点"]
  app --> help["/help<br/>1 页 · 0 端点"]
  app --> interview["/interview<br/>5 页 · 15 端点"]
  app --> job_fairs["/job-fairs<br/>9 页 · 32 端点"]
  app --> jobs["/jobs<br/>2 页 · 32 端点"]
  app --> legal["/legal<br/>1 页 · 32 端点"]
  ...
  app --> resume["/resume<br/>19 页 · 42 端点"]
...
| `/assistant` | AssistantPage | `apps/kiosk/src/pages/assistant/AssistantPage.tsx` | 37 | 13 |
| `/campus` | CampusPage | `apps/kiosk/src/pages/campus/CampusPage.tsx` | 32 | — |
...
| `/job-fairs` | JobFairsPage | `apps/kiosk/src/pages/job-fairs/JobFairsPage.tsx` | 32 | — |
| `/job-fairs/:id` | JobFairDetailPage | `apps/kiosk/src/pages/job-fairs/JobFairDetailPage.tsx` | 32 | — |
| `/job-fairs/:id/companies` | FairCompaniesPage | `apps/kiosk/src/pages/job-fairs/FairCompaniesPage.tsx` | 32 | — |
| `/job-fairs/:id/companies/:companyId` | FairCompanyDetailPage | `apps/kiosk/src/pages/job-fairs/FairCompanyDetailPage.tsx` | 32 | — |
| `/job-fairs/:id/map` | FairMapPage | `apps/kiosk/src/pages/job-fairs/FairMapPage.tsx` | 32 | — |
| `/job-fairs/:id/materials` | FairMaterialsPage | `apps/kiosk/src/pages/job-fairs/FairMaterialsPage.tsx` | 32 | — |
| `/job-fairs/:id/stats` | FairStatsPage | `apps/kiosk/src/pages/job-fairs/FairStatsPage.tsx` | 32 | — |
| `/job-fairs/:id/visit-plan` | FairVisitPlanPage | `apps/kiosk/src/pages/job-fairs/FairVisitPlanPage.tsx` | 11 | — |
| `/job-fairs/checkin` | JobFairCheckinPage | `apps/kiosk/src/pages/job-fairs/JobFairCheckinPage.tsx` | 32 | — |
| `/jobs` | JobsPage | `apps/kiosk/src/pages/jobs/JobsPage.tsx` | 32 | — |
| `/jobs/:id` | JobDetailPage | `apps/kiosk/src/pages/jobs/JobDetailPage.tsx` | 32 | — |
| `/legal/:doc` | LegalDocPage | `apps/kiosk/src/pages/legal/LegalDocPage.tsx` | 32 | 1 |
...
| `/resume/generate` | ResumeGeneratePage | `apps/kiosk/src/pages/resume/ResumeGeneratePage.tsx` | 32 | 7 |
| `/resume/generate/preview` | ResumeGeneratePreviewPage | `apps/kiosk/src/pages/resume/ResumeGeneratePreviewPage.tsx` | 33 | 6 |
| `/resume/job-fit` | JobFitPage | `apps/kiosk/src/pages/resume/JobFitPage.tsx` | 36 | 8 |
...
| `/resume/optimize` | ResumeOptimizePage | `apps/kiosk/src/pages/resume/ResumeOptimizePage.tsx` | 33 | 5 |
| `/resume/optimize/compare` | ResumeOptimizeComparePage | `apps/kiosk/src/pages/resume/ResumeOptimizeComparePage.tsx` | 32 | 6 |
| `/resume/parse` | ResumeParsePage | `apps/kiosk/src/pages/resume/ResumeParsePage.tsx` | 32 | 8 |
| `/resume/report` | ResumeReportPage | `apps/kiosk/src/pages/resume/ResumeReportPage.tsx` | 33 | 6 |
...
| `/resume/source` | ResumeSourcePage | `apps/kiosk/src/pages/resume/ResumeSourcePage.tsx` | 32 | 7 |
