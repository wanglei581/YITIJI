...
**改文件前查这里**，就知道会红哪条门禁。共 1535 个文件被至少一条门禁断言。
...
<details>
<summary><code>services/api/src/</code> — 514 个文件</summary>
...
| `services/api/src/ai/providers/mock.provider.ts` | `verify-ai-cost-coverage.ts`<br/>`verify-ai-safety-aigc.ts`<br/>`verify-resume-draft-versions.ts`<br/>`verify-resume-export-formats.ts`<br/>`verify-resume-generate.ts`<br/>`verify-resume-layout-export.ts`<br/>`verify-resume-template-fill.ts`<br/>`verify-toolbox-ai-skill-intents.ts` |
