...
| 文件 | 被这些门禁断言 |
| --- | --- |
| `apps/miniapp/app.json` | `verify-miniapp-static.mjs`<br/>`verify-miniapp-review-backend.ts` |
...
<details>
<summary><code>services/api/src/</code> — 512 个文件</summary>
...
| `services/api/src/recruitment-hosting/recruitment-hosting.ts` | `verify-recruitment-hosting-default-off.ts` |
