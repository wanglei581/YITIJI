...
| `services/api/scripts/verify-member-print-order-idempotency.ts` | `src/member-print-orders/order-submission-ledger.ts` |
...
**改文件前查这里**，就知道会红哪条门禁。共 1495 个文件被至少一条门禁断言。
...
<details>
<summary><code>services/api/src/</code> — 477 个文件</summary>
