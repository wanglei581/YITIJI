...
**改文件前查这里**，就知道会红哪条门禁。共 1477 个文件被至少一条门禁断言。
...
| `apps/kiosk/scripts/verify-profile-commercial-first-batch.mjs` | `verify-profile-commercial-first-batch.mjs` |
| `apps/kiosk/scripts/verify-profile-documents-inkpaper.mjs` | `verify-profile-commercial-first-batch.mjs`<br/>`verify-profile-inkpaper-home.mjs` |
...
| `apps/kiosk/src/pages/profile/me/printOrders/__fixtures__/member-print-orders-login-smoke.json` | `verify-lightflow-profile-entry.mjs`<br/>`verify-profile-commercial-first-batch.mjs`<br/>`verify-profile-inkpaper-home.mjs`<br/>`verify-profile-print-orders-login-smoke.mjs` |
...
| `apps/kiosk/src/services/api/mockAdapter.ts` | `verify-profile-commercial-first-batch.mjs` |
...
| `apps/kiosk/src/services/files/usbImportApi.ts` | `verify-resume-phone-upload-ui.mjs`<br/>`verify-no-raw-error-render.mjs` |
...
| `apps/kiosk/tests/visual/fusion-self-assessment-flow.spec.ts` | `verify-fusion-w3.mjs` |
| `apps/kiosk/tests/visual/fusion-w2-print.spec.ts` | `verify-fusion-w6.mjs`<br/>`verify-print-color-duplex-capability.ts` |
| `apps/kiosk/tests/visual/fusion-w2-scan.spec.ts` | `verify-fusion-w6.mjs` |
| `apps/kiosk/tests/visual/fusion-w3.spec.ts` | `verify-fusion-w3.mjs` |
...
| `apps/miniapp/pages/documents/documents-helpers.js` | `verify-word-conversion-ui.mjs` |
...
| 文件 | 被这些门禁断言 |
| --- | --- |
| `docs/acceptance/member-print-orders-login-smoke.md` | `verify-profile-commercial-first-batch.mjs`<br/>`verify-profile-inkpaper-home.mjs`<br/>`verify-profile-print-orders-login-smoke.mjs` |
...
| 文件 | 被这些门禁断言 |
| --- | --- |
| `docs/acceptance/profile-commercial-preprod-redeploy-and-acceptance.md` | `verify-profile-commercial-first-batch-acceptance.ts` |
...
| 文件 | 被这些门禁断言 |
| --- | --- |
| `docs/product/user-data-flow-matrix.md` | `verify-profile-commercial-first-batch.mjs`<br/>`verify-profile-inkpaper-home.mjs`<br/>`verify-member-data-retention.ts` |
...
| 文件 | 被这些门禁断言 |
| --- | --- |
| `docs/progress/today-claude.md` | `verify-profile-commercial-first-batch.mjs` |
...
<details>
<summary><code>docs/superpowers/plans/</code> — 11 个文件</summary>
...
| `docs/superpowers/plans/2026-07-12-sign-stamp-implementation.md` | `verify-profile-commercial-first-batch.mjs` |
...
| 文件 | 被这些门禁断言 |
| --- | --- |
| `docs/superpowers/specs/2026-07-12-sign-stamp-design.md` | `verify-profile-commercial-first-batch.mjs` |
...
| `packages/shared/src/types/jobMaterials.ts` | `verify-ai-artifact-print-url-contract.mjs`<br/>`verify-profile-commercial-first-batch.mjs`<br/>`verify-resume-template-fill.ts` |
...
| `services/api/prisma/migrations/20260711120000_add_fair_material_print_bridge/migration.sql` | `verify-profile-commercial-first-batch.mjs` |
...
| `services/api/prisma/postgres/migrations/20260711120000_add_fair_material_print_bridge/migration.sql` | `verify-profile-commercial-first-batch.mjs` |
...
<details>
<summary><code>services/api/scripts/</code> — 77 个文件</summary>
...
| `services/api/src/common/filters/http-exception.filter.ts` | `verify-admin-ops.ts`<br/>`verify-backend-p0-http.ts`<br/>`verify-console-screen-snapshot.ts`<br/>`verify-contract-review-http.ts`<br/>`verify-error-observability.ts`<br/>`verify-http-exception-filter.ts`<br/>`verify-job-favorites-http.ts`<br/>`verify-member-assets-c2d.ts`<br/>`verify-member-auth.ts`<br/>`verify-member-print-order-idempotency-http.ts`<br/>`verify-member-qr-login.ts`<br/>`verify-member-step-up.ts`<br/>`verify-package-order-idempotency-http.ts`<br/>`verify-print-jobs.ts`<br/>`verify-recruitment-content-http.ts`<br/>`verify-upload-sessions-http.ts`<br/>`verify-upload-sessions.ts` |
...
| `services/api/src/files/file-validation.ts` | `verify-profile-commercial-first-batch.mjs`<br/>`verify-cos-storage.ts`<br/>`verify-document-conversion.ts`<br/>`verify-file-display-truth.ts`<br/>`verify-file-internal-auth.ts`<br/>`verify-member-data-export-files.ts`<br/>`verify-upload-sessions.ts` |
| `services/api/src/files/file.types.ts` | `verify-ai-artifact-print-url-contract.mjs`<br/>`verify-file-retention-ui.mjs`<br/>`verify-profile-commercial-first-batch.mjs`<br/>`verify-kiosk-upload-print-contract.ts`<br/>`verify-member-data-export-files.ts`<br/>`verify-member-data-retention.ts`<br/>`verify-upload-sessions.ts` |
...
| `services/api/src/upload-sessions/upload-sessions.service.ts` | `verify-profile-commercial-first-batch.mjs`<br/>`verify-upload-scene.ts`<br/>`verify-upload-sessions.ts` |
