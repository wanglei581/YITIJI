...
> **2026-09-06（PTR-15）**：岗位浏览量 / 招聘会服务数据 / 打印扫描量的机构归因**未落地**（行为日志无不可变 `sourceOrgId` 快照）。Partner `/stats` 只展示在架快照与同步概况，不得承诺「效果」。

| 功能 | school | public_service | hr_agency | fair_organizer | enterprise |
|------|:------:|:--------------:|:---------:|:--------------:|:----------:|
| 查看本机构数据来源统计 | ✅ | ✅ | ✅ | ✅ | ✅ |
| 查看岗位浏览量 | ⚠️ 归因未落地 | ⚠️ 归因未落地 | ⚠️ 归因未落地 | ⚠️ 归因未落地 | ⚠️ 归因未落地 |
| 查看招聘会服务数据 | ⚠️ 归因未落地 | ⚠️ 归因未落地 | ❌ | ⚠️ 归因未落地 | ❌ |
| 查看打印/扫描量（按来源聚合） | ⚠️ 归因未落地 | ⚠️ 归因未落地 | ⚠️ 归因未落地 | ⚠️ 归因未落地 | — |
