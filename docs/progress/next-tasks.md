...
> 最后更新：2026-06-07（AI求职材料中心 B-2 基础页数识别 + A4 规范化评估 + PII 遮挡评估最小契约已推进，B-1 浏览器链路已手验）
