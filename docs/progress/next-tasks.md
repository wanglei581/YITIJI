...
| 5. 51 稿逐态产品化与原生小程序 | 部分 Kiosk 页面按原稿结构合流本地候选；路由登记不等于视觉或功能完成；小程序按原生交互适配同一业务状态。 | Claude 按原稿逐页核布局、动作、等待/空/错/禁用和 AI 能力，Grok 修真实合同，逐条业务流程完成小程序与一体机一致性。原稿中误导性的语音、打印能力等文案须按真实能力修正。 | 全部状态 1080×1920 实屏/触控、390 辅助屏、Windows Edge/27 寸现场与微信真机，不能用静态 HTML 演示冒充运行时。 |
