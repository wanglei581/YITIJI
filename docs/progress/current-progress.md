...
### P0-1/P0-2 Kiosk UX 第一批优化（2026-06-04，`claude/l2-4c-kiosk-auth-shell`，未提交）
...
### P1 第二批 Kiosk 服务中心"可用能力优先"优化（2026-06-04，未提交）
...
### 第三批 AssistantPage 快捷咨询面板（2026-06-04，未提交）
