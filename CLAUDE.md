...
> 历史口径（2026-08-01 快照，非当前阶段）：本节此前标注「2026-06-12 上线前收口」，已滞后约 7 周。实时进度只写进 `docs/progress/current-progress.md`，不再在本文件维护第二份阶段声明。2026-08-01 当时处于 **F1 D2′ 演练收口**，`productionF1` 为 **NO-GO**。下面只保留已封板、长期不变的里程碑；不得用本段判断今天的任务或生产状态：
