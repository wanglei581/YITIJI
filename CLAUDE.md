...
- 合规边界不变：岗位、招聘会、校招、企业展示仍只能做第三方 / 官方来源信息入口，不得出现平台内投递、收简历、筛选、邀约或 Offer 闭环。
...
- 微信小程序底部导航：首页、职业生活圈、求职、我的（四 Tab）。「职业生活圈」承载小青 AI 助手、真实 AI 求职工具、材料与打印入口；材料包、职业圈动态、今日早报在后端接口到位前只能展示为明确标注「未开放」的可解释入口，不得伪造下单、动态或早报结果。Kiosk 导航仍按其独立信息架构维护，不能把小程序四 Tab 机械套用到大屏。
