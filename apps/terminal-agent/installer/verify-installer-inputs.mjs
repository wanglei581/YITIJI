...
assert.match(agentEntrypoint, /\.version\('0\.3\.2'\)/)
...
assert.match(exeUpgrade, /EXE_UPGRADE_PASS from=0\.3\.1 to=0\.3\.2/)
assert.match(exeUpgrade, /An unprovisioned upgrade must remain Stopped\/Manual until the GUI succeeds/)
assert.match(exeUpgrade, /ProgramData state was not retained across the 0\.3\.1 to 0\.3\.2 upgrade/)
...
assert.match(workflow, /ff638a0dedcb4ee920b92510c73a90aabb29b443/)
