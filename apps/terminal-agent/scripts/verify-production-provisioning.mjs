...
assert.match(installer, /\$preservedLocalSettings\.Contains\("localUpdateControlToken"\)/)
...
assert.match(installer, /localUpdateControlToken\s*=\s*\$effectiveUpdateControlToken/)
