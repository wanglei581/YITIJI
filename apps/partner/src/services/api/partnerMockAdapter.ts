...
let PARTNER_JOBS: PartnerJobRecord[] = [
  ...
  { id: 'pj9', externalId: 'UNI-2026-JOB-0035', title: '存量驳回无原因',   company: '某未知公司',     city: '本市', category: 'fulltime', sourceUrl: 'https://job.uni.edu.cn/j/35', syncTime: '2026-05-24 18:00', reviewStatus: 'rejected',  publishStatus: 'draft',       sourceOrgId: 'org-uni-001', sourceName: '高校就业信息网', rejectReason: null },
]
