// Partner 登录页 — 密码 / 短信验证码双模式 + 找回密码 + 登录后手机号本人验证
//
// 接口接线（保持不变）：
...
// 协议勾选未通过时阻断登录 / 发码。视觉对齐 login-trio-v1 原型 ③（陶土主题，样式见 ./login.css）。
...
const REMEMBER_KEY = 'partner_login_prefill_v1'
        ...
        <div className={`c-card${shaking ? ' shake' : ''}`}>
          ...
          {mode === 'password' ? (
            ...
            <form className="c-pane" onSubmit={submitSms}>
              <div className="c-field">
                <label htmlFor="partner-sms-phone">
              ...
              <div className="c-field">
                <label htmlFor="partner-sms-code">
          ...
          <div className="c-modal-card">
            ...
            {resetStep === 'identity' && (
              <form onSubmit={startReset}>
                <div className="c-field">
                  <label htmlFor="partner-reset-identity">
                    <b className="fno">01</b>机构账号 / 手机号
                  </label>
                  <div className="c-inputwrap">
                    <Building2Icon className="lead" size={18} aria-hidden="true" />
                    <input
                      id="partner-reset-identity"
                      type="text"
                      placeholder="请输入机构账号或绑定手机号"
                      value={resetIdentity}
            ...
            {resetStep === 'code' && (
              <form onSubmit={verifyReset}>
                <div className="c-field">
                  <label htmlFor="partner-reset-code">
                    <b className="fno">02</b>短信验证码
                  </label>
                  <div className="c-inputwrap">
                    <MessageSquareTextIcon className="lead" size={18} aria-hidden="true" />
                    <input
                      id="partner-reset-code"
                      type="text"
                      inputMode="numeric"
                      placeholder="6 位数字，5 分钟内有效"
                      value={resetCode}
            ...
            {resetStep === 'password' && (
              <form onSubmit={completeReset}>
                <div className="c-field">
                  <label htmlFor="partner-reset-password">
            ...
            <div className="c-modal-foot">
              无法自助找回？联系<b>平台运营</b>协助重置，重置操作将记录日志。
            </div>
          </div>
        </div>
      )}
      ...
      {phoneVerifyUser && (
        <div className="c-modal" role="dialog" aria-modal="true" aria-label="手机号本人验证">
          <form className="c-modal-card" onSubmit={confirmPhoneVerification}>
            ...
            <div className="c-field">
              <label htmlFor="partner-phone-verify-code">
                <b className="fno">01</b>短信验证码
              </label>
              <div className="c-inputwrap">
                <MessageSquareTextIcon className="lead" size={18} aria-hidden="true" />
                <input
                  id="partner-phone-verify-code"
                  type="text"
                  inputMode="numeric"
                  placeholder="6 位数字，5 分钟内有效"
