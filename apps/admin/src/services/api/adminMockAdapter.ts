...
let JOB_SOURCES: AdminJobSourceRecord[] = [
  { id: 'js1',  sourceOrgId: 'org-zhilian-001',    sourceName: '智联招聘',       externalId: 'ZL-2026-884521',    sourceUrl: 'https://jobs.zhaopin.com/j/884521',    title: '前端开发工程师', company: '上海某科技有限公司', city: '上海', salary: '15-25K', tags: ['全职', '前端', 'React'], description: '负责公司 Web 前端开发，需熟悉 React、TypeScript。',      requirements: '本科及以上，2 年前端经验。',     syncTime: '2026-05-25 08:00', reviewStatus: 'approved',  publishStatus: 'published'   },
  { id: 'js2',  sourceOrgId: 'org-51job-001',       sourceName: '前程无忧',       externalId: '51J-20260525-0021', sourceUrl: 'https://www.51job.com/j/20260525-0021', title: 'Java 后端开发',  company: '北京某互联网公司',   city: '北京', salary: '20-30K', tags: ['全职', '后端', 'Java'], description: '负责后台服务开发，Spring Boot + MySQL。',                requirements: '本科及以上，3 年 Java 经验。',   syncTime: '2026-05-25 08:00', reviewStatus: 'approved',  publishStatus: 'published'   },
  { id: 'js3',  sourceOrgId: 'org-city-talent-001', sourceName: '市人才网',       externalId: 'RC-2026-330099',    sourceUrl: 'https://rcw.city.gov.cn/j/330099',     title: '行政专员',       company: '某政府机关单位',     city: '本市', salary: '5-8K',  tags: ['全职', '行政'],   description: '负责日常行政事务管理。',                                  requirements: '大专及以上，有行政工作经验。',   syncTime: '2026-05-25 07:30', reviewStatus: 'approved',  publishStatus: 'draft'       },
  { id: 'js4',  sourceOrgId: 'org-boss-001',        sourceName: 'Boss直聘',       externalId: 'BP-M9234712',       sourceUrl: 'https://www.zhipin.com/j/M9234712',    title: 'UI 设计师',      company: '深圳某设计公司',     city: '深圳', salary: '12-20K', tags: ['全职', '设计', 'Figma'],   description: '负责产品界面设计，需扎实视觉设计能力。',                  requirements: '本科及以上，3 年 UI 设计经验。', syncTime: '2026-05-25 09:00', reviewStatus: 'pending',   publishStatus: 'draft'       },
  { id: 'js5',  sourceOrgId: 'org-zhilian-001',    sourceName: '智联招聘',       externalId: 'ZL-2026-892204',    sourceUrl: 'https://jobs.zhaopin.com/j/892204',    title: '数据分析师',     company: '杭州某电商平台',     city: '杭州', salary: '18-28K', tags: ['全职', '数据', 'Python'],    description: '负责业务数据分析，建立分析模型。',                        requirements: '本科及以上，2 年数据分析经验。', syncTime: '2026-05-25 09:00', reviewStatus: 'reviewing', publishStatus: 'draft'       },
  { id: 'js6',  sourceOrgId: 'org-city-talent-001', sourceName: '市人才网',       externalId: 'RC-2026-330106',    sourceUrl: 'https://rcw.city.gov.cn/j/330106',     title: '护士',           company: '某三甲医院',         city: '本市', salary: '6-10K', tags: ['全职', '医疗', '护理'],   description: '临床护理工作，参与病房护理。',                            requirements: '护理专业大专及以上，具备护士执业资格证。',               syncTime: '2026-05-25 07:30', reviewStatus: 'approved',  publishStatus: 'published'   },
  { id: 'js7',  sourceOrgId: 'org-51job-001',       sourceName: '前程无忧',       externalId: '51J-20260524-0099', sourceUrl: 'https://www.51job.com/j/20260524-0099', title: '机械工程师',     company: '苏州某制造企业',     city: '苏州', salary: '10-18K', tags: ['全职', '机械', '制造'],      description: '负责机械零部件设计和工艺改进。',                          requirements: '机械工程相关专业本科，2 年以上经验。',                   syncTime: '2026-05-24 18:00', reviewStatus: 'approved',  publishStatus: 'unpublished' },
  { id: 'js8',  sourceOrgId: 'org-uni-001',         sourceName: '高校就业信息网', externalId: 'GX-2026-CG-0042',  sourceUrl: 'https://job.uni.edu.cn/j/42',          title: '应届生储备干部', company: '某大型国企',         city: '全国', salary: '面议',   tags: ['校招', '管培', '全职'],    description: '管理培训生项目，培养未来核心管理人才。',                  requirements: '2026 届毕业生，本科及以上。',    syncTime: '2026-05-24 16:00', reviewStatus: 'approved',  publishStatus: 'published'   },
  { id: 'js9',  sourceOrgId: 'org-boss-001',        sourceName: 'Boss直聘',       externalId: 'BP-M9251003',       sourceUrl: 'https://www.zhipin.com/j/M9251003',    title: '产品经理',       company: '广州某科技公司',     city: '广州', salary: '25-40K', tags: ['全职', '产品', 'PM'], description: '负责产品规划与设计，协调研发推进迭代。',                  requirements: '本科及以上，5 年以上产品经理经验。',                     syncTime: '2026-05-25 09:00', reviewStatus: 'rejected',  publishStatus: 'draft'       },
...
const MOCK_AUDIT_LOGS: AuditLogRecord[] = [
  ...
  { id: 'al7',  actorId: 'mock-admin-001', actorRole: 'admin', action: 'auth.password_login', targetType: 'system', targetId: null,       payloadJson: '{"result":"success"}',                ipAddress: '10.20.0.2', userAgent: 'Mozilla/5.0', requestId: 'req-0007', createdAt: '2026-05-25T08:00:00.000Z' },
  { id: 'al13', actorId: 'mock-admin-001', actorRole: 'admin', action: 'auth.sms_login',      targetType: 'system', targetId: null,       payloadJson: '{"result":"success"}',                ipAddress: '10.20.0.3', userAgent: 'Mozilla/5.0 (Macintosh)', requestId: 'req-0013', createdAt: '2026-05-24T20:00:00.000Z' },
