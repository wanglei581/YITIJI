      ...
      actions={
        <div className="flex items-center gap-2.5">
          ...
          {alertCount > 0 && (
            <a
              href="/alerts"
              className="inline-flex h-9 items-center gap-1.5 rounded-[9px] bg-neutral-900 px-4 text-[13px] font-bold text-white shadow-[0_8px_18px_rgba(16,48,43,0.18)] transition-transform hover:-translate-y-px active:scale-[0.97]"
            >
