...
export interface JobFairServiceInterface {
  getJobFairs(params?: { status?: string; page?: number; pageSize?: number }): Promise<PaginatedResponse<ExternalJobFairDTO>>
  getJobFairById(id: string): Promise<ApiResponse<ExternalJobFairDTO | null>>
  getFairCompanies(fairId: string, params?: { page?: number; pageSize?: number }): Promise<PaginatedResponse<FairCompanyDTO>>
  ...
  getFairMaterials(fairId: string, params?: { page?: number; pageSize?: number }): Promise<PaginatedResponse<FairMaterialDTO>>
...
export const getJobFairs        = (params?: { status?: string; page?: number; pageSize?: number }) => adapter.getJobFairs(params)
export const getJobFairById     = (id: string)                    => adapter.getJobFairById(id)
export const getFairCompanies   = (fairId: string, params?: { page?: number; pageSize?: number }) => adapter.getFairCompanies(fairId, params)
...
export const getFairMaterials   = (fairId: string, params?: { page?: number; pageSize?: number }) => adapter.getFairMaterials(fairId, params)
