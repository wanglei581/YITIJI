...
export const SCAN_ASK = {
  ...
  'cleanup-holding': {
    text: '上一场扫描还没收完尾。',
    em: '还没收完尾',
    doing: '本机正在向服务端确认上一位那条任务确实已经取消。确认之前不建新会话 —— 服务端会把面板上扫出来的文件投给这台机器上最早那条还在等文件的任务。',
  },
  invalid: {
    text: '这一页没有可创建的扫描类型。',
    em: '没有可创建的扫描类型',
  ...
  'awaiting-ack': {
    text: '会话建成了，还没拿到投递授权。',
    em: '还没拿到投递授权',
    doing: '服务端确认之前，面板上扫出来的文件不会投到这一场，所以先别按开始。它也不会被别人收走 —— 没确认的任务对谁都不可投递。',
  },
  'panel-instruction': {
    text: '接下来去机器面板上。',
    em: '去机器面板上',
