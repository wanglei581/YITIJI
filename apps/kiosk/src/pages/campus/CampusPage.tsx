...
function AiJobTab() {
  ...
  return (
    <div className="space-y-4 px-5 py-4">
      ...
      <div className="grid grid-cols-1 gap-3">
        <AiFeatureCard icon={FileTextIcon} iconBg="bg-blue-50" iconColor="text-blue-600" title="AI简历诊断" desc="简历分析与诊断，提供专业修改建议，提升简历通过率。" cta="开始诊断" onClick={() => navigate('/resume')} />
  ...
  return (
    <div className="space-y-4 px-5 py-4">
      ...
      <Card className="p-2">
        ...
        <PrintRow icon={SparklesIcon} title="AI简历服务" subtitle="解析 / 诊断 / 优化 / 打印" onClick={() => navigate('/resume')} />
        {hasMaterials && (
