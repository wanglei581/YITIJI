...
export function PhoneUploadPage() {
  ...
  return (
    <main className="fusion-w5 fusion-w5--auth k1-phone-upload service-desk grid min-h-[100svh] place-items-center bg-[#2a2a26] px-0 py-0 font-sans text-neutral-900 sm:py-6" data-kiosk-screen="phone-upload" data-visual-theme="service-desk" data-ux-density="touch" data-kiosk-presentation="fusion-youth" data-kiosk-viewport="mobile">
      {!ready ? (
