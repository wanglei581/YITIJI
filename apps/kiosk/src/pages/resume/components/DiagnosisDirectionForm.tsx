    ...
    <Card className="p-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <div className="flex items-center gap-2">
            ...
            <p className="text-base font-bold text-neutral-900">诊断方向设置</p>
          </div>
          <p className="mt-1 max-w-[58ch] text-sm leading-relaxed text-neutral-500">
        ...
        <button
          ...
          className={[
            ...
            genericDiagnosis ? 'border-primary-500 bg-primary-50 text-primary-700' : 'border-neutral-200 bg-white text-neutral-600',
          ].join(' ')}
        >
          通用诊断
        </button>
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-2">
        <label className="block">
          <span className="text-xs font-semibold text-neutral-500">目标岗位</span>
          <input
            value={targetJob}
            disabled={genericDiagnosis}
        ...
        <label className="block">
          <span className="text-xs font-semibold text-neutral-500">行业方向</span>
          <select
        ...
        <label className="block">
          <span className="text-xs font-semibold text-neutral-500">经验级别</span>
          <select
        ...
        <label className="block">
          <span className="text-xs font-semibold text-neutral-500">求职场景</span>
          <select
            value={targetScene}
            disabled={genericDiagnosis}
