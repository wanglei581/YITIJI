...
export default defineConfig({
  ...
  testMatch: /(?:fusion-w2-(?:print|scan|tools)|print-hub-qx|print-fulfill-qx|cashier-qx|pickup-claim-receipt)\.spec\.ts$/,
  ...
  reporter: process.env.CI
    ? [['line'], ['html', { outputFolder: '../../test-results/kiosk-fusion-w2-report', open: 'never' }]]
    : 'list',
  use: {
