...
const w6RouteDefinitions: readonly W6RouteDefinition[] = [
  ...
  { pattern: '/smart-campus/freshman-insights', url: '/smart-campus/freshman-insights', marker: '[data-kiosk-component="page-frame"]:has-text("迎新服务导览")', featureText: '迎新服务导览' },
  ...
  { pattern: '/print-scan/convert', url: '/print-scan/convert', marker: w2('print-scan-convert'), featureText: '图片转 PDF' },
  { pattern: '/print-scan/sign', url: '/print-scan/sign', marker: w2('print-scan-sign'), featureText: '签名盖章' },
  { pattern: '/print/scan-convert', url: '/print/scan-convert', expectedPath: compatibilityRedirects['/print/scan-convert'], marker: w2('print-scan-convert'), featureText: '图片转 PDF' },
  ...
  { pattern: '/job-fairs', url: '/job-fairs', marker: qx, featureText: '招聘会' },
  { pattern: '/fairs-service', url: '/fairs-service', marker: 'h1:text-is("招聘会信息")', featureText: '招聘会信息' },
  { pattern: '/job-fairs/checkin', url: '/job-fairs/checkin', marker: qx, featureText: '到场指引' },
  { pattern: '/job-fairs/:id', url: '/job-fairs/fair-001', marker: qx, featureText: '2026 青岛高校毕业生招聘会' },
  { pattern: '/job-fairs/:id/companies', url: '/job-fairs/fair-001/companies', marker: qx, featureText: '参展企业' },
  ...
  { pattern: '/job-fairs/:id/map', url: '/job-fairs/fair-001/map', marker: qx, featureText: '场馆导览' },
  { pattern: '/job-fairs/:id/materials', url: '/job-fairs/fair-001/materials', marker: qx, featureText: '活动物料' },
