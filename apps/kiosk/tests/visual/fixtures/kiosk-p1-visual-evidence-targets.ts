...
export const visualEvidenceTargets: readonly VisualEvidenceTarget[] = [
  ...
  primary({ targetId: '43', prototypePath: 'docs/design/kiosk-redesign-2026-08/28-jobfair-enhanced.html', referenceKind: 'PRIMARY', routeOrState: ['/job-fairs/checkin'], captureUrls: ['/job-fairs/checkin'], precondition: 'Return a synthetic official-source fair and external check-in link.', readyMarker: '[data-qx-frame="true"]' }),
  primary({ targetId: '44', prototypePath: 'docs/design/kiosk-redesign-2026-08/28-jobfair-enhanced.html', referenceKind: 'PRIMARY', routeOrState: ['/job-fairs/:id/companies'], captureUrls: ['/job-fairs/fair-001/companies'], precondition: 'Return synthetic fair companies and zones.', readyMarker: '[data-qx-frame="true"]' }),
  primary({ targetId: '45', prototypePath: 'docs/design/kiosk-redesign-2026-08/44-fair-company-detail.html', referenceKind: 'PRIMARY', routeOrState: ['/job-fairs/:id/companies/:companyId'], captureUrls: ['/job-fairs/fair-001/companies/fair-company-001'], precondition: 'Return one synthetic fair company with sourced jobs.', readyMarker: '[data-qx-frame="true"]' }),
  primary({ targetId: '46', prototypePath: 'docs/design/kiosk-redesign-2026-08/28-jobfair-enhanced.html', referenceKind: 'PRIMARY', routeOrState: ['/job-fairs/:id/map'], captureUrls: ['/job-fairs/fair-001/map'], precondition: 'Return synthetic fair map metadata through the current envelope.', readyMarker: '[data-qx-frame="true"]' }),
  primary({ targetId: '47', prototypePath: 'docs/design/kiosk-redesign-2026-08/28-jobfair-enhanced.html', referenceKind: 'PRIMARY', routeOrState: ['/job-fairs/:id/materials'], captureUrls: ['/job-fairs/fair-001/materials'], precondition: 'Return synthetic printable-material metadata without signed URLs.', readyMarker: '[data-qx-frame="true"]' }),
  primary({ targetId: '48', prototypePath: 'docs/design/kiosk-redesign-2026-08/28-jobfair-enhanced.html', referenceKind: 'PRIMARY', routeOrState: ['/job-fairs/:id/visit-plan'], captureUrls: ['/job-fairs/fair-001/visit-plan'], precondition: 'Authenticate visibly and return a synthetic visit plan.', readyMarker: '[data-qx-frame="true"]' }),
