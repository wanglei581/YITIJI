...
export const visualEvidenceTargets: readonly VisualEvidenceTarget[] = [
  ...
  primary({ targetId: '38', prototypePath: 'docs/design/kiosk-proto-2026-07/38-interview-setup.html', referenceKind: 'PRIMARY', routeOrState: ['/interview'], captureUrls: ['/interview'], precondition: 'Open the blank setup form without uploading a resume.', readyMarker: '[data-kiosk-screen="interview-setup"]' }),
