...
export const visualEvidenceTargets: readonly VisualEvidenceTarget[] = [
  ...
  primary({ targetId: '49', prototypePath: 'docs/design/kiosk-proto-2026-07/49-fair-stats.html', referenceKind: 'PRIMARY', routeOrState: ['/job-fairs/:id/stats'], captureUrls: ['/job-fairs/fair-001/stats'], precondition: 'Return synthetic aggregate fair statistics without personal data.', readyMarker: '.w4-page-frame' }),
