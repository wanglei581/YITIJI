...
export default defineConfig({
  ...
  webServer: {
    command: 'VITE_API_MODE=http VITE_E2E_MOCK_TERMINAL_SESSION_TOKEN=playwright-terminal-session-fixture VITE_API_BASE_URL=/api/v1 VITE_USE_TRTC_CALL=true VITE_TERMINAL_ID=KSK-001 VITE_KIOSK_LOGOUT_IDLE_SEC=180 VITE_KIOSK_PRIVACY_IDLE_SEC=3 VITE_KIOSK_PRIVACY_BUSY_DEFER_SEC=2 pnpm build && pnpm exec vite preview --host 127.0.0.1 --port 4187 --strictPort',
